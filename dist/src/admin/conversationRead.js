 ...
 */
export async function getConversationSnapshotById(id, limitMessages = 50) {
 ...
 */
export async function getConversationSnapshotByContact(providerContact, limitMessages = 50) {
    return await prisma.conversation.findUnique({
...
//# sourceMappingURL=conversationRead.js.map