...
describe("Admin Read API (Debug)", () => {
    ...
    describe("GET /admin/conversations/:id", () => {
        it("should return 401 if x-admin-key is missing", async () => {
            const resp = await supertest(fastify.server).get("/admin/conversations/00000000-0000-0000-0000-000000000000");
...
//# sourceMappingURL=admin.read.test.js.map